...
mencoder mf://*.png -mf w=1280:h=800:fps=15:type=png -ovc x264 -x264encopts threads=auto:pass=1:bitrate=$bitrate:slow_firstpass -oac copy -o $output
mencoder mf://*.png -mf w=1280:h=800:fps=15:type=png -ovc x264 -x264encopts threads=auto:pass=2:bitrate=$bitrate -oac lavc -lavcopts acodec=vorbis -o "${output}"
