...
# ssh keys
eval $(keychain --eval --timeout 90 --agents ssh -Q --quiet --noask arch_rsa id_rsa skeletonkey_rsa)
alias auth='eval $(keychain --eval --timeout 90 --agents ssh -Q --quiet arch_rsa id_rsa skeletonkey_rsa)'
